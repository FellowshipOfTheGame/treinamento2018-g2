...
public class Movimento_Player : MonoBehaviour
{
    ...
    public float velocidade = 4;                        //magnitude da velocidade  
    ...
    void Update()
    {
        ...
        //MOVIMENTO
        if(this.CompareTag("Player1") || this.CompareTag("Clone"))
            ...
            rb.velocity = new Vector2(Input.GetAxis("Horizontal2") * velocidade, Input.GetAxis("Vertical2") * velocidade);
